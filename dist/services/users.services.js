...
var services = {
    ...
    getByIdCount: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.users.count({
                        where: {
                            id: id,
                        },
                    })];
    ...
    register: function (data) { return __awaiter(void 0, void 0, void 0, function () {
        var hashedPassword, result, error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt_1.default.hash((data === null || data === void 0 ? void 0 : data.password) || "user123", Number(process.env.PASSWORD_SALT) || 10)];
                case 1:
    ...
    login: function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
        var user, error, isPasswordMatch, error, secretKey, token, refreshToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, bcrypt_1.default.compare(password, user.password || "user123")];
                case 2:
                    ...
                    secretKey = process.env.SECRET_KEY_JWT || "secretBookApp";
                    user.password = null;
                    token = jsonwebtoken_1.default.sign({ userId: user.id, role: user.role }, secretKey, {
                        expiresIn: "12h",
                    });
                    refreshToken = jsonwebtoken_1.default.sign({ userId: user.id, role: user.role }, secretKey, {
                        expiresIn: "30d",
                    });
                    return [2 /*return*/, [
                            token,
    ...
    resetPassword: function (id, password) { return __awaiter(void 0, void 0, void 0, function () {
        var hashedPassword, result, error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt_1.default.hash(password, Number(process.env.PASSWORD_SALT) || 10)];
                case 1:
                    hashedPassword = _a.sent();
