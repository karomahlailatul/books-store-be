...
var services = {
    ...
    getById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.sellers.findUnique({
                        where: {
                            id: id,
                        },
                        // include: {
    ...
    getByIdCount: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.sellers.count({
                        where: {
                            id: id,
                        },
                    })];
    ...
    create: function (data) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.sellers.create({
                        data: data,
                    })];
                case 1:
                    result = _a.sent();
    ...
    updateById: function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.sellers.update({
                        where: {
                            id: id,
                        },
                        data: data,
    ...
    deleteById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.sellers.delete({
                        where: {
                            id: id,
                        },
                    })];
