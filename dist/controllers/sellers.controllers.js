...
var controllers = {
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    offset = (page - 1) * limit;
                    return [4 /*yield*/, sellers_services_1.default.getByPagination({
                            page: page,
                            limit: limit,
                            offset: offset,
                            search: search,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sellers_services_1.default.getById(id)];
                case 1:
                    result = _a.sent();
    ...
    create: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, sellers_services_1.default.create({
                            name: name_1,
                            status: true,
    ...
    updateById: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, _a, name_2, userId, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, , 6]);
                    id = Number(req.params.id);
                    return [4 /*yield*/, sellers_services_1.default.getByIdCount(id)];
                case 1:
                    _b.sent();
                    _a = req.body, name_2 = _a.name, userId = _a.userId;
                    if (!userId) return [3 /*break*/, 3];
                    return [4 /*yield*/, users_services_1.default.getByIdCount(userId)];
                case 2:
                    _b.sent();
                    _b.label = 3;
                case 3: return [4 /*yield*/, sellers_services_1.default.updateById(id, {
                        name: name_2,
                        user: { connect: { id: userId } },
                    })];
                case 4:
    ...
    deleteById: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sellers_services_1.default.deleteById(id)];
                case 2:
                    _a.sent();
