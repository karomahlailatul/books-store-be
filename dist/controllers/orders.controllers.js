...
var orders_services_1 = __importDefault(require("../services/orders.services"));
...
var controllers = {
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    offset = (page - 1) * limit;
                    return [4 /*yield*/, orders_services_1.default.getByPagination({
                            page: page,
                            limit: limit,
                            offset: offset,
                            search: search,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, orders_services_1.default.getById(id)];
                case 1:
                    result = _a.sent();
    ...
    create: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, userId, bookId, quantity, checkBook, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                    _a = req.body, userId = _a.userId, bookId = _a.bookId, quantity = _a.quantity;
                    return [4 /*yield*/, users_services_1.default.getByIdCount(userId)];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, books_services_1.default.getById(bookId)];
                case 2:
                    checkBook = _b.sent();
                    return [4 /*yield*/, orders_services_1.default.create({
                            paymentLink: "",
                            statusOrder: "PENDING",
                            quantity: quantity,
    ...
    updateById: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, checkOrders, _a, userId, bookId, quantity, _b, statusOrder, paymentLink, checkBook, error_4;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    checkOrders = _c.sent();
                    _a = req.body, userId = _a.userId, bookId = _a.bookId, quantity = _a.quantity, _b = _a.statusOrder, statusOrder = _b === void 0 ? "PENDING" : _b, paymentLink = _a.paymentLink;
                    if (!userId) return [3 /*break*/, 3];
                    return [4 /*yield*/, users_services_1.default.getByIdCount(userId)];
                case 2:
                    _c.sent();
                    _c.label = 3;
                case 3: return [4 /*yield*/, books_services_1.default.getById(bookId || checkOrders.bookId)];
                case 4:
                    checkBook = _c.sent();
                    return [4 /*yield*/, orders_services_1.default.updateById(id, {
                            paymentLink: paymentLink,
                            statusOrder: statusOrder,
                            quantity: quantity,
                            total: (checkBook === null || checkBook === void 0 ? void 0 : checkBook.price) * (quantity || checkOrders.quantity),
                            user: { connect: { id: userId } },
                            book: { connect: { id: bookId } },
                        })];
                case 5:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    id = Number(req.params.id);
                    return [4 /*yield*/, orders_services_1.default.getByIdCount(id)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, orders_services_1.default.deleteById(id)];
                case 2:
                    _a.sent();
